...
{
    public class SubrubroPageViewModel
    {
        public IEnumerable<SubrubroListViewModel> List { get; set; }
        ...
        public SubrubroPageViewModel(string selectedFilter, string selectedSort)
        {
