...
{
    public class TipoProductoPageViewModel
    {
        public IEnumerable<TipoProductoListViewModel> List { get; set; }
        ...
        public TipoProductoPageViewModel(string selectedFilter, string selectedSort)
        {
