...
{
    public class UnidadMedidaPageViewModel
    {
        public IEnumerable<UnidadMedidaListViewModel> List { get; set; }
        ...
        public UnidadMedidaPageViewModel(string selectedFilter, string selectedSort)
        {
