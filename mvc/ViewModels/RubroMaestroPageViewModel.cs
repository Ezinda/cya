...
{
    public class RubroMaestroPageViewModel
    {
        public IEnumerable<RubroMaestroListViewModel> List { get; set; }
        ...
        public RubroMaestroPageViewModel(string selectedFilter, string selectedSort)
        {
